package cn.gateway.session.handlers;

import cn.gateway.bind.IGenericReference;
import cn.gateway.session.BaseHandler;
...
public class SessionServerHandler extends BaseHandler<FullHttpRequest> {
    ...
    protected void session(ChannelHandlerContext ctx, Channel channel, FullHttpRequest request) {
        ...
        String test = reference.$invoke("test") + " " + System.currentTimeMillis();
        // 头部信息设置
